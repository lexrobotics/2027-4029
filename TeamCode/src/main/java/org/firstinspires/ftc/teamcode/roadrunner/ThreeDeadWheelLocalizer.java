...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 11586.21; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -11827.6; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -5786.78; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        par0.setDirection(DcMotorSimple.Direction.REVERSE); // What does this do exactly?
